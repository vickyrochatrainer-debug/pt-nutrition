...
function getVeganBreakfastSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Açaí & Hemp Protein Bowl',
      ingredients: [
        `${Math.round(p * 0.45 / 0.31)}g hemp seeds`,
        '100g frozen açaí pulp (unsweetened), thawed',
        `${Math.round(c * 0.3 / 0.13)}g frozen mango chunks`,
        '1/2 cup light coconut milk',
        '1 scoop plant protein powder',
        `${Math.round(c * 0.2 / 0.12)}g fresh pineapple, diced`,
        '1 tbsp shredded coconut',
      ],
      instructions: [
        'Blend açaí, mango, coconut milk, and plant protein until thick and smooth.',
        'Add minimal liquid — the bowl should hold its shape.',
        'Pour into a bowl.',
        'Top with pineapple, hemp seeds, and shredded coconut.',
        'Serve immediately.',
      ],
    },
    {
      title: 'Red Lentil Breakfast Bowl',
      ingredients: [
        `${Math.round(p * 0.7 / 0.09)}g red lentils, dry`,
        `${Math.round(c * 0.3 / 0.20)}g sweet potato, small cubes`,
        '1 cup baby spinach',
        `${Math.round(f * 0.4 / 0.15)}g avocado, sliced`,
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
      ...
      instructions: [
        'Cook red lentils in 2 cups water with turmeric and cumin, 15 minutes until soft.',
        'Meanwhile, roast sweet potato in olive oil at 425°F / 220°C for 20 minutes.',
        'Stir spinach into hot lentils and let wilt 1 minute.',
        'Spoon into a bowl. Top with sweet potato and avocado.',
        'Squeeze lemon juice. Season with salt.',
      ],
    },
    {
      title: 'Black Bean & Corn Morning Bowl',
      ingredients: [
        `${Math.round(p * 0.65 / 0.089)}g canned black beans, rinsed and warmed`,
        '1/2 cup corn kernels (fresh or frozen)',
        `${Math.round(f * 0.45 / 0.15)}g avocado, diced`,
        '1/2 cup fresh salsa or pico de gallo',
        `${Math.round(c * 0.3 / 0.28)}g cooked brown rice`,
        '1 lime, juiced',
        'Cumin, chili powder, salt, fresh cilantro',
      ],
      instructions: [
        'Warm black beans with cumin and chili powder in a small pan.',
        'Warm corn in the same pan for 2 minutes.',
        'Assemble bowl: rice, black beans, corn.',
        'Top with avocado and salsa.',
        'Squeeze lime juice and scatter cilantro.',
      ],
    },
    {
      title: 'Overnight Protein Quinoa Bowl',
      ingredients: [
        `${Math.round(c * 0.45 / 0.21)}g dry quinoa, cooked and chilled`,
        '1 scoop plant protein powder',
        '1 cup light coconut milk',
        '1 tbsp chia seeds',
        '1/2 cup mixed berries',
      ...
      instructions: [
        'Mix cooked quinoa with plant protein, coconut milk, and chia seeds.',
        'Stir in maple syrup. Cover and refrigerate overnight.',
        'In the morning, stir well — mixture should be thick and creamy.',
        'Top with mixed berries and hemp seeds.',
        'Eat cold straight from the fridge.',
      ],
    },
    {
      title: 'Pumpkin & Hemp Seed Porridge',
      ingredients: [
        `${Math.round(c * 0.45 / 0.07)}g pumpkin purée (canned, unsweetened)`,
        `${Math.round(p * 0.5 / 0.31)}g hemp seeds`,
        '1 cup light coconut milk',
        '1 scoop plant protein powder',
        '1 tsp maple syrup',
        '1/2 tsp cinnamon, 1/4 tsp ginger, pinch of nutmeg',
        `${Math.round(c * 0.2 / 0.13)}g fresh mango, diced`,
      ],
      instructions: [
        'Combine pumpkin purée and coconut milk in a saucepan over medium heat.',
        'Stir in plant protein, cinnamon, ginger, and nutmeg.',
        'Cook 5 minutes until warm and thick, stirring frequently.',
        'Remove from heat. Stir in maple syrup and hemp seeds.',
        'Serve in a bowl topped with fresh mango.',
      ],
    },
    {
      title: 'Tempeh & Pepper Morning Scramble',
      ingredients: [
        `${Math.round(p * 0.8 / 0.19)}g tempeh, crumbled`,
        '1 red bell pepper, diced',
        '1/2 onion, diced',
        '1 cup baby spinach',
        `${Math.round(f * 0.35 / 0.92)} tsp olive oil`,
        '1 tsp smoked paprika, cumin, garlic powder, salt',
        '2 tbsp low-sodium soy sauce or tamari',
      ],
      instructions: [
        'Crumble tempeh into small pieces.',
        'Heat olive oil in a skillet over medium-high. Add onion and pepper. Cook 3 minutes.',
        'Add tempeh. Cook 5 minutes, stirring, until golden. Season with spices.',
        'Splash in soy sauce. Stir in spinach and cook 1 minute until wilted.',
        'Serve immediately.',
      ],
    },
  ];
...
function getVeganLunchSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Moroccan Lentil Stew over Millet',
      ingredients: [
        `${Math.round(p * 0.7 / 0.09)}g green lentils, dry`,
        `${Math.round(c * 0.35 / 0.23)}g millet, dry`,
        '1 can (400g) diced tomatoes',
        '1 tsp harissa paste (or 1 tsp chili flakes)',
        '1/2 onion, 3 cloves garlic, 1 tsp ginger',
        `${Math.round(f * 0.25 / 0.92)} tsp olive oil`,
        '2 tsp ras el hanout or cumin, coriander, cinnamon, salt',
        'Fresh cilantro, lemon juice',
      ],
      instructions: [
        'Cook millet: bring 2× volume water to boil, add millet, simmer 18 minutes. Fluff and set aside.',
        'Heat olive oil. Sauté onion 4 minutes. Add garlic, ginger, and spices. Cook 1 minute.',
        'Add lentils, tomatoes, harissa, and 2 cups water. Bring to boil, simmer 25 minutes.',
        'Season with salt and lemon juice. Top with cilantro.',
        'Serve over millet.',
      ],
    },
    {
      title: 'Black-Eyed Pea & Kale Bowl',
      ingredients: [
        `${Math.round(p * 0.7 / 0.089)}g canned black-eyed peas, rinsed`,
        `${Math.round(c * 0.35 / 0.28)}g cooked brown rice`,
        '3 cups kale, stems removed, roughly torn',
        `${Math.round(c * 0.2 / 0.20)}g sweet potato, roasted cubes`,
        `${Math.round(f * 0.35 / 0.92)} tsp olive oil`,
        '3 cloves garlic, 1 tbsp apple cider vinegar',
        '1 tsp smoked paprika, cumin, salt, chili flakes',
      ],
      instructions: [
        'Roast sweet potato with olive oil and paprika at 425°F / 220°C for 22 minutes.',
        'Sauté kale with garlic in olive oil over medium heat 5 minutes. Add vinegar and season.',
        'Warm black-eyed peas with cumin in a pan.',
        'Assemble bowls: rice, black-eyed peas, kale, sweet potato.',
        'Season with salt and chili flakes.',
      ],
    },
    {
      title: 'Thai Peanut Tempeh Bowl',
      ingredients: [
        `${Math.round(p * 0.7 / 0.19)}g tempeh, sliced`,
        `${Math.round(c * 0.4 / 0.28)}g cooked jasmine rice`,
        '2 cups shredded red cabbage and carrots',
        `${Math.round(f * 0.4 / 0.53)}g natural peanut butter`,
        '2 tbsp lime juice, 1 tbsp soy sauce, 1 tsp sesame oil, 1 tsp grated ginger',
        '1 tsp sriracha (optional)',
        'Fresh cilantro, lime wedge',
      ],
      instructions: [
        'Whisk peanut butter, lime juice, soy sauce, sesame oil, ginger, sriracha, and 3 tbsp water into a sauce.',
        'Pan-fry tempeh in a dry skillet over medium heat 3–4 minutes per side until golden.',
        'Toss cabbage and carrots with half the peanut sauce.',
        'Assemble bowls: rice, slaw, tempeh.',
        'Drizzle remaining sauce. Top with cilantro and lime wedge.',
      ],
    },
    {
      title: 'Grilled Portobello Mushroom Bowl',
      ingredients: [
        `${Math.round(p * 0.5 / 0.032)}g portobello mushroom caps (2–3 large)`,
        `${Math.round(p * 0.35 / 0.089)}g canned chickpeas, rinsed`,
        `${Math.round(c * 0.4 / 0.21)}g cooked quinoa`,
        '2 cups mixed greens',
        `${Math.round(f * 0.4 / 0.92)} tsp olive oil`,
        '2 tbsp balsamic vinegar, 2 cloves garlic',
        'Salt, pepper, fresh herbs',
      ],
      instructions: [
        'Marinate portobello caps in olive oil, balsamic, garlic, salt, and pepper for 10 minutes.',
        'Grill or pan-sear caps 4–5 minutes per side until tender and deeply browned.',
        'Warm chickpeas with a pinch of cumin.',
        'Assemble bowls: quinoa, greens, chickpeas.',
        'Top with sliced portobello. Drizzle remaining marinade.',
      ],
    },
    {
      title: 'Vegan Sushi Bowl with Nori & Edamame',
      ingredients: [
        `${Math.round(p * 0.6 / 0.11)}g shelled edamame, steamed`,
        `${Math.round(c * 0.45 / 0.28)}g cooked sushi rice`,
        `${Math.round(f * 0.4 / 0.15)}g avocado, sliced`,
        '1/2 cup shredded carrots, 1/2 cucumber, sliced',
      ...
      instructions: [
        'Season warm rice with rice vinegar and a pinch of salt. Cool slightly.',
        'Arrange rice in a bowl.',
        'Top with edamame, avocado, carrots, and cucumber.',
        'Lay nori strips over the top. Sprinkle sesame seeds.',
        'Mix soy sauce and sesame oil into a dipping sauce. Serve on the side.',
      ],
    },
    {
      title: 'Pumpkin & Red Lentil Soup',
      ingredients: [
        `${Math.round(p * 0.65 / 0.09)}g red lentils, dry`,
        `${Math.round(c * 0.3 / 0.07)}g pumpkin or butternut squash, cubed`,
        '1 can (400ml) light coconut milk',
        '1/2 onion, 3 cloves garlic, 1 tsp grated ginger',
        `${Math.round(f * 0.15 / 0.92)} tsp coconut oil`,
        '3 cups vegetable broth, 2 tsp curry powder, 1 tsp turmeric, salt',
        'Fresh cilantro, lime juice',
      ],
      instructions: [
        'Heat coconut oil. Sauté onion 4 minutes. Add garlic, ginger, and spices. Cook 1 minute.',
        'Add pumpkin, lentils, broth, and coconut milk.',
        'Bring to a boil, then simmer 25 minutes until pumpkin and lentils are very soft.',
        'Blend partially for a creamy-chunky texture. Season with salt and lime juice.',
...
function getVeganDinnerSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'White Bean & Kale Tuscan Stew',
      ingredients: [
        `${Math.round(p * 0.65 / 0.089)}g canned white beans (cannellini), rinsed`,
        '3 cups kale, stems removed, roughly chopped',
        '1 can (400g) diced tomatoes',
        '1/2 onion, 4 cloves garlic',
        `${Math.round(c * 0.25 / 0.28)}g cooked brown rice or farro`,
        `${Math.round(f * 0.25 / 0.92)} tsp olive oil`,
        '1 tsp Italian seasoning, chili flakes, salt, pepper',
        'Fresh basil, lemon juice',
      ],
      instructions: [
        'Heat olive oil. Sauté onion 4 minutes. Add garlic and Italian seasoning. Cook 1 minute.',
        'Add tomatoes and simmer 8 minutes.',
        'Add white beans and kale. Cook 5 minutes until kale is tender.',
        'Season with salt, pepper, lemon juice, and chili flakes.',
        'Serve over rice with fresh basil.',
      ],
    },
    {
      title: 'Lentil & Butternut Squash Curry',
      ingredients: [
        `${Math.round(p * 0.65 / 0.09)}g red lentils, dry`,
        `${Math.round(c * 0.3 / 0.08)}g butternut squash, cubed`,
        '1 can (400ml) light coconut milk',
        '1/2 onion, 3 cloves garlic, 1 tsp ginger',
        `${Math.round(c * 0.2 / 0.28)}g cooked basmati rice`,
        `${Math.round(f * 0.15 / 0.92)} tsp coconut oil`,
        '2 tsp curry powder, 1 tsp cumin, 1 tsp turmeric, salt',
      ],
      instructions: [
        'Heat coconut oil. Sauté onion 4 minutes. Add garlic, ginger, and spices. Cook 1 minute.',
        'Add squash, lentils, coconut milk, and 1 cup water.',
        'Simmer 25–30 minutes until squash is soft and lentils dissolve.',
        'Season with salt.',
        'Serve over basmati rice.',
      ],
    },
    {
      ...
      ingredients: [
        `${Math.round(p * 0.5 / 0.032)}g cremini or mixed mushrooms, quartered`,
        `${Math.round(p * 0.4 / 0.09)}g green or brown lentils, dry`,
        `${Math.round(c * 0.3 / 0.28)}g cooked basmati rice`,
        '1/2 cup red wine or extra veggie broth',
        '1 cup vegetable broth, 2 tbsp tomato paste',
        '1/2 onion, 3 cloves garlic, 2 sprigs thyme',
        `${Math.round(f * 0.25 / 0.92)} tsp olive oil`,
        'Salt, pepper',
      ],
      instructions: [
        'Cook lentils in broth 25 minutes until tender. Drain and set aside.',
        'Heat olive oil over high. Sear mushrooms without stirring 4 minutes until golden.',
        'Add onion, garlic, and thyme. Cook 3 minutes.',
        'Add tomato paste and red wine. Cook 2 minutes. Add broth.',
        'Simmer 10 minutes. Stir in lentils. Season. Serve over rice.',
      ],
    },
    {
      title: 'Chickpea & Spinach Saag (Palak Chana)',
      ingredients: [
        `${Math.round(p * 0.7 / 0.089)}g canned chickpeas, rinsed`,
        `${Math.round(c * 0.35 / 0.28)}g cooked basmati rice`,
        '3 cups fresh spinach, blended or finely chopped',
        '1 can (400g) diced tomatoes',
        '1/2 onion, 3 cloves garlic, 1 tsp ginger',
        `${Math.round(f * 0.2 / 0.92)} tsp coconut oil`,
        '2 tsp garam masala, 1 tsp cumin, 1 tsp coriander, 1 tsp turmeric, salt',
      ],
      instructions: [
        'Heat coconut oil. Sauté onion 5 minutes. Add garlic, ginger, and all spices. Cook 1 minute.',
        'Add tomatoes. Cook 8 minutes until sauce thickens.',
        'Stir in blended or chopped spinach. Simmer 5 minutes.',
        'Add chickpeas. Cook 10 minutes until flavors meld. Season.',
        'Serve over basmati rice.',
      ],
    },
    {
      ...
      ingredients: [
        `${Math.round(p * 0.65 / 0.089)}g canned white beans, rinsed`,
        '1 can (400g) crushed tomatoes',
        '1/2 red bell pepper, diced',
        '1/2 onion, diced',
        '3 cloves garlic, minced',
        `${Math.round(f * 0.3 / 0.92)} tsp olive oil`,
        '1 tsp cumin, smoked paprika, chili flakes, salt',
        `${Math.round(c * 0.3 / 0.21)}g cooked quinoa`,
        'Fresh parsley, lemon juice',
      ],
      instructions: [
        'Heat olive oil. Sauté onion and pepper 5 minutes. Add garlic and spices. Cook 1 minute.',
        'Add crushed tomatoes. Simmer 10 minutes until thick.',
        'Stir in white beans. Simmer 8 more minutes.',
        'Season with salt and lemon juice.',
        'Serve over quinoa. Top with parsley.',
      ],
    },
    {
      title: 'Tempeh & Miso Stir-Fry with Brown Rice',
      ingredients: [
        `${Math.round(p * 0.75 / 0.19)}g tempeh, cubed`,
        `${Math.round(c * 0.4 / 0.28)}g cooked brown rice`,
        ...
        '2 tbsp low-sodium soy sauce, 1 tsp sesame oil, 1 tsp grated ginger',
        `${Math.round(f * 0.3 / 0.92)} tsp avocado oil`,
      ],
      instructions: [
        'Mix miso, soy sauce, sesame oil, and ginger into a glaze.',
        'Toss tempeh in half the glaze. Let sit 5 minutes.',
        'Heat avocado oil in a wok over high heat. Add tempeh. Cook 4 minutes until golden.',
        'Add vegetables. Stir-fry 3 minutes. Pour remaining glaze over everything.',
...
function getVeganSnackSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Mango Coconut Protein Shake',
      ingredients: [
        '1 scoop plant protein powder (~20g protein)',
        `${Math.round(c * 0.5 / 0.13)}g frozen mango chunks`,
        '1 cup light coconut milk',
      ...
      instructions: [
        ...
        'Add a splash more coconut milk if too thick.',
        'Pour into a glass over ice.',
        'Serve immediately.',
      ],
    },
    {
      title: 'Black Bean & Avocado Protein Bowl',
      ingredients: [
        `${Math.round(p * 0.7 / 0.089)}g canned black beans, rinsed and warmed`,
        `${Math.round(f * 0.5 / 0.15)}g avocado, mashed`,
        '1/2 cup fresh salsa or pico de gallo',
        '1 lime, juiced',
        'Cumin, chili powder, salt',
        'Fresh cilantro',
        `${Math.round(c * 0.25 / 0.20)}g sweet potato chips or plantain chips`,
      ],
      instructions: [
        'Warm black beans with cumin and chili powder.',
        'Mash avocado with lime juice and salt.',
        'Spoon black beans into a bowl.',
        'Top with avocado mash and salsa.',
        'Scatter cilantro. Serve with plantain chips on the side.',
      ],
    },
    {
      title: 'Roasted Pumpkin Seed Trail Mix',
      ingredients: [
        `${Math.round(f * 0.45 / 0.49)}g raw pumpkin seeds (pepitas)`,
        `${Math.round(c * 0.4 / 0.65)}g dried mango or cranberries`,
        `${Math.round(p * 0.4 / 0.31)}g hemp seeds`,
        '2 tbsp dark chocolate chips (dairy-free)',
        '1 tsp olive oil, 1/2 tsp cinnamon, pinch of sea salt',
      ],
      instructions: [
        'Preheat oven to 350°F / 175°C.',
        'Toss pumpkin seeds with olive oil, cinnamon, and salt.',
        'Spread on a baking sheet. Roast 8–10 minutes until lightly golden.',
        'Cool completely, then mix with hemp seeds, dried fruit, and chocolate chips.',
        'Store in an airtight container up to 2 weeks.',
      ],
    },
    {
      title: 'Overnight Mango Quinoa Parfait',
      ingredients: [
        `${Math.round(c * 0.4 / 0.21)}g cooked quinoa, chilled`,
        '1 scoop plant protein powder',
        '1/2 cup light coconut milk',
        `${Math.round(c * 0.3 / 0.13)}g fresh or frozen mango, diced`,
        `${Math.round(f * 0.3 / 0.31)}g hemp seeds`,
        '1 tsp maple syrup',
        '1 tbsp chia seeds',
      ],
      instructions: [
        'Mix quinoa, plant protein, coconut milk, chia seeds, and maple syrup.',
        'Cover and refrigerate overnight.',
        'In the morning, layer quinoa mixture and mango in a jar.',
        'Top with hemp seeds.',
        'Eat cold.',
      ],
    },
    {
      title: 'Watermelon Hemp Seed Protein Shake',
      ingredients: [
        `${Math.round(c * 0.55 / 0.07)}g watermelon, cubed and frozen`,
        `${Math.round(p * 0.4 / 0.31)}g hemp seeds`,
        '1 scoop plant protein powder',
        '1/2 cup light coconut milk',
        '1 tbsp lime juice',
      ...
      instructions: [
        'Add frozen watermelon, hemp seeds, plant protein, coconut milk, lime juice, and ice to a blender.',
        'Blend 45 seconds until smooth.',
        'Add more coconut milk if needed for consistency.',
        'Pour into a glass.',
        'Garnish with fresh mint.',
      ],
    },
    {
      title: 'Crispy Lentil & Mango Snack Bowl',
      ingredients: [
        `${Math.round(p * 0.65 / 0.09)}g canned lentils, rinsed and dried`,
        `${Math.round(c * 0.35 / 0.13)}g fresh mango, cubed`,
        `${Math.round(f * 0.3 / 0.92)} tsp olive oil`,
        '1 tsp smoked paprika, cumin, salt',
        '1 tbsp lime juice',
        'Fresh cilantro',
      ],
      instructions: [
        'Preheat oven to 425°F / 220°C.',
        'Pat lentils completely dry. Toss with olive oil, paprika, cumin, and salt.',
        'Roast on a baking sheet 25–30 minutes until crispy, shaking halfway.',
        'Cool 5 minutes — they crisp up further.',
        'Toss with mango, lime juice, and cilantro. Serve immediately.',
      ],
    },
  ];
}
...
function getVegetarianBreakfastSwapOptions(p, c, f) {
  return [
    ...
    },
    {
      ...
      ingredients: [
        `${Math.max(2, Math.round(p * 0.7 / 6))} whole eggs`,
        '2 large avocados, halved and pitted',
        `${Math.round(p * 0.2 / 0.14)}g feta cheese, crumbled`,
        '1/2 cup cherry tomatoes, halved',
        `${Math.round(f * 0.1 / 0.92)} tsp olive oil`,
        'Salt, pepper, chili flakes, fresh chives',
      ],
      instructions: [
        'Preheat oven to 400°F / 200°C.',
        'Scoop a little flesh from each avocado half to make room for the egg.',
        'Place avocados in a muffin tin to keep them stable. Crack an egg into each.',
        'Season with salt, pepper, and chili flakes. Top with feta.',
        'Bake 12–15 minutes until whites are set. Scatter tomatoes and chives.',
      ],
    },
    {
      title: 'Halloumi & Veggie Hash',
      ingredients: [
        `${Math.round(p * 0.65 / 0.18)}g halloumi cheese, cubed`,
        `${Math.round(c * 0.35 / 0.20)}g sweet potato, small cubes`,
        '1 red bell pepper, diced',
        '1/2 zucchini, diced',
        '1/4 onion, diced',
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
      ...
      instructions: [
        'Cook sweet potato in olive oil in a skillet 8 minutes until golden.',
        'Add bell pepper, zucchini, and onion. Cook 4 minutes.',
        'Add halloumi cubes. Cook 3–4 minutes, turning occasionally, until golden on all sides.',
        'Season with smoked paprika, cumin, and salt.',
        'Top with fresh parsley and serve.',
      ],
    },
    {
      title: 'Raspberry & Seed Protein Smoothie',
      ingredients: [
        '1 scoop vanilla protein powder (~25g protein)',
        `${Math.round(c * 0.45 / 0.12)}g frozen raspberries`,
        `${Math.round(p * 0.3 / 0.31)}g hemp seeds`,
        '1 tbsp chia seeds',
        '1 cup unsweetened oat milk or almond milk',
        '1/2 cup ice',
      ...
      instructions: [
        'Add all ingredients to a blender.',
        'Blend 45–60 seconds until smooth and creamy.',
        'Taste and add honey if more sweetness is needed.',
        'Pour into a glass and drink immediately.',
      ],
    },
    {
      title: 'Poached Eggs & Spinach Potato Hash',
      ingredients: [
        `${Math.max(2, Math.round(p * 0.6 / 6))} whole eggs, poached`,
        `${Math.round(c * 0.5 / 0.17)}g baby potatoes, halved and boiled`,
        '2 cups fresh spinach',
        `${Math.round(p * 0.2 / 0.14)}g feta cheese, crumbled`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        '2 cloves garlic, salt, pepper, paprika',
      ],
      instructions: [
        'Boil halved potatoes 10 minutes until just tender. Drain.',
        'Pan-fry potatoes in butter over medium-high heat 5 minutes until golden. Add garlic and paprika.',
        'Stir in spinach and cook until wilted, 2 minutes. Season.',
        'Poach eggs: simmer water, add vinegar, swirl, gently drop in eggs, cook 3–4 minutes.',
        'Serve potato hash topped with poached eggs and feta.',
      ],
    },
    {
      title: 'Quark Bowl with Berries & Seeds',
      ingredients: [
        `${Math.round(p * 0.8 / 0.12)}g quark or low-fat fromage frais`,
        '1 cup mixed berries (strawberries, blueberries, raspberries)',
        `${Math.round(f * 0.4 / 0.49)}g sunflower seeds or pumpkin seeds`,
        `${Math.round(p * 0.1 / 0.31)}g hemp seeds`,
        '1 tsp honey or agave',
        'Pinch of cinnamon',
      ],
      instructions: [
        ...
        'Scatter sunflower seeds and hemp seeds over the top.',
        'Drizzle honey and sprinkle cinnamon.',
        'Eat immediately.',
      ],
    },
    {
      title: 'Veggie & Egg Breakfast Wrap',
      ingredients: [
        `${Math.max(3, Math.round(p * 0.7 / 6))} whole eggs, scrambled`,
        `${Math.max(1, Math.round(c * 0.45 / 0.50 / 28))} large whole wheat tortillas`,
        '1/2 red bell pepper, diced',
        '1/4 onion, diced',
        '1 cup baby spinach',
        `${Math.round(f * 0.3 / 0.25)}g shredded cheddar cheese`,
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
        'Salt, pepper, hot sauce',
      ],
      instructions: [
        'Sauté pepper and onion in olive oil 3 minutes.',
        'Add spinach and cook until wilted, 1 minute.',
        'Whisk eggs with salt and pepper. Pour into pan. Scramble until just set.',
        'Warm tortilla in a dry pan or microwave 20 seconds.',
        'Fill with egg scramble and cheese. Fold and serve with hot sauce.',
      ],
    },
  ];
}
  ...
  return [
    ...
    },
    {
      ...
      ingredients: [
        ...
        '1/4 red onion, finely diced',
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
        '2 tbsp lime juice, cumin, chili powder, salt, fresh cilantro',
      ],
      instructions: [
        'Cook quinoa per package and let cool slightly.',
        'Combine quinoa, black beans, corn, tomatoes, and red onion.',
        'Drizzle olive oil and lime juice. Season with cumin, chili powder, and salt.',
        'Add avocado and toss gently.',
        'Top with cilantro and serve at room temperature.',
      ],
    },
    {
      title: 'Chickpea Flour Falafel & Tabbouleh Bowl',
      ingredients: [
        `${Math.round(p * 0.65 / 0.089)}g canned chickpeas, rinsed and dried`,
        `${Math.round(c * 0.25 / 0.65)}g chickpea flour`,
        '1/2 cup fresh parsley, finely chopped',
        '1/2 cup fresh mint',
        '1 cup cherry tomatoes, halved',
        '1/2 cucumber, diced',
        `${Math.round(c * 0.25 / 0.21)}g cooked bulgur or quinoa`,
        `${Math.round(f * 0.35 / 0.92)} tsp olive oil`,
        'Lemon juice, cumin, garlic, salt',
      ],
      instructions: [
        'Blend chickpeas, chickpea flour, parsley, cumin, garlic, and salt into a dough. Refrigerate 30 min.',
        'Form into small balls. Pan-fry in olive oil 3 minutes per side until golden.',
        'Mix bulgur/quinoa with tomatoes, cucumber, mint, lemon juice, and olive oil.',
        'Assemble bowls with tabbouleh and falafel.',
    ...
    },
    {
      ...
      ingredients: [
        `${Math.round(c * 0.45 / 0.28)}g cooked sushi rice, seasoned with rice vinegar`,
        `${Math.round(f * 0.4 / 0.15)}g avocado, sliced`,
        '1/2 cucumber, cut into thin matchsticks',
        '1/2 cup shredded carrots',
        `${Math.round(p * 0.5 / 0.14)}g edamame, shelled and steamed`,
        '2 nori sheets, torn',
        '2 tbsp low-sodium soy sauce or tamari, 1 tsp sesame oil',
        `${Math.round(f * 0.2 / 0.49)}g sesame seeds`,
      ],
      instructions: [
        'Season warm rice with rice vinegar and salt. Cool slightly.',
        'Arrange rice in bowls.',
        'Top with avocado, cucumber, carrots, and edamame.',
        'Lay nori pieces over the top. Sprinkle sesame seeds.',
        'Mix soy sauce and sesame oil. Drizzle over everything.',
      ],
    },
    {
      title: 'Lentil & Roasted Beet Salad',
      ingredients: [
        `${Math.round(p * 0.65 / 0.09)}g green lentils, cooked`,
        `${Math.round(c * 0.25 / 0.09)}g beetroot, roasted and cubed`,
        '2 cups mixed greens or arugula',
        `${Math.round(f * 0.3 / 0.49)}g pumpkin seeds`,
        `${Math.round(p * 0.2 / 0.14)}g feta or goat cheese, crumbled`,
        `${Math.round(f * 0.25 / 0.92)} tsp olive oil`,
        '2 tbsp balsamic vinegar, 1 tsp Dijon mustard, salt, pepper',
      ],
      instructions: [
        'Roast beets at 400°F / 200°C for 35–40 minutes until tender. Cool and cube.',
        'Whisk olive oil, balsamic, mustard, salt, and pepper into a dressing.',
        'Toss lentils with half the dressing.',
        'Layer greens, lentils, and beets in a bowl.',
        'Top with cheese and pumpkin seeds. Drizzle remaining dressing.',
      ],
    },
    {
      title: 'Saag Paneer with Brown Rice',
      ingredients: [
        `${Math.round(p * 0.65 / 0.18)}g paneer, cubed`,
        '3 cups fresh spinach, wilted and blended',
        `${Math.round(c * 0.4 / 0.28)}g cooked brown rice`,
        '1/2 onion, 3 cloves garlic, 1 tsp ginger',
        `${Math.round(f * 0.25 / 0.81)}g butter or ghee`,
        '1 tsp cumin, garam masala, coriander, turmeric, salt',
      ],
      instructions: [
        'Pan-fry paneer in ghee until golden on all sides. Set aside.',
        'Sauté onion 4 minutes. Add garlic, ginger, and spices. Cook 1 minute.',
        'Stir in blended spinach. Simmer 5 minutes.',
        'Add paneer. Coat in sauce. Simmer 5 more minutes. Season.',
        'Serve over brown rice.',
      ],
    },
    {
      title: 'Cheese & Veggie Stuffed Portobello',
      ingredients: [
        `${Math.round(p * 0.5 / 0.032)}g portobello mushroom caps (2–3 large)`,
        `${Math.round(p * 0.4 / 0.11)}g part-skim ricotta`,
        `${Math.round(p * 0.15 / 0.07)}g shredded mozzarella`,
        '1 cup cherry tomatoes, halved',
        '1 cup baby spinach, wilted',
        `${Math.round(f * 0.25 / 0.92)} tsp olive oil`,
        '1 tsp Italian seasoning, garlic powder, salt',
      ],
      instructions: [
        'Preheat oven to 400°F / 200°C.',
        'Brush mushroom caps with olive oil. Season with salt.',
        'Mix ricotta, spinach, tomatoes, garlic powder, and Italian seasoning.',
        'Fill each cap with ricotta mixture. Top with mozzarella.',
        'Bake 20–22 minutes until mushrooms are tender and cheese is golden.',
      ],
    },
  ];
}
...
function getVegetarianDinnerSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Moroccan Chickpea & Mushroom Tagine',
      ingredients: [
        `${Math.round(p * 0.55 / 0.089)}g canned chickpeas, rinsed`,
        `${Math.round(p * 0.2 / 0.032)}g cremini mushrooms, quartered`,
        `${Math.round(c * 0.4 / 0.21)}g cooked quinoa`,
        '1 can (400g) diced tomatoes',
        '1/2 onion, 3 cloves garlic, 1 tsp grated ginger',
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
        '2 tsp ras el hanout or cumin+coriander+cinnamon+paprika, salt',
        'Lemon juice, fresh cilantro',
      ],
      instructions: [
        'Heat olive oil. Sauté onion 4 minutes. Add garlic, ginger, and spices. Cook 1 minute.',
        'Add mushrooms. Cook 5 minutes until golden.',
        'Add tomatoes and chickpeas. Simmer 20 minutes until sauce thickens.',
        'Season with salt and lemon juice. Top with cilantro.',
        'Serve over quinoa.',
      ],
    },
    {
      title: 'Black Bean & Veggie Chili',
      ingredients: [
        `${Math.round(p * 0.55 / 0.089)}g canned black beans, rinsed`,
        `${Math.round(p * 0.2 / 0.089)}g canned kidney beans, rinsed`,
        '1 can (400g) diced tomatoes',
        '1 cup corn, 1/2 zucchini diced, 1/2 onion diced',
        '3 cloves garlic, 2 tbsp tomato paste',
        `${Math.round(c * 0.25 / 0.21)}g cooked quinoa or brown rice`,
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
        '2 tsp chili powder, 1 tsp cumin, smoked paprika, salt',
      ],
      instructions: [
        'Heat olive oil. Sauté onion and zucchini 5 minutes. Add garlic and tomato paste. Cook 1 minute.',
        'Add spices. Cook 1 minute. Add tomatoes, beans, and corn.',
        'Simmer 20–25 minutes until thick. Season with salt.',
        'Serve over quinoa or rice.',
        'Top with avocado, sour cream, or shredded cheese if desired.',
      ],
    },
    {
      title: 'Halloumi & Roasted Pepper Bowl',
      ingredients: [
        `${Math.round(p * 0.7 / 0.18)}g halloumi, sliced`,
        '2 large bell peppers (red, yellow), halved',
        `${Math.round(c * 0.4 / 0.21)}g cooked quinoa`,
        '2 cups mixed greens',
        `${Math.round(f * 0.3 / 0.92)} tsp olive oil`,
      ...
      instructions: [
        ...
        'Brush peppers with olive oil. Roast 25 minutes until charred and soft.',
        'Pan-fry halloumi slices over medium-high heat 2–3 minutes per side until golden.',
        'Assemble bowls: quinoa, greens, roasted peppers, halloumi.',
        'Drizzle balsamic glaze. Top with fresh basil.',
      ],
    },
    {
      title: 'Indian Masala Dal over Basmati Rice',
      ingredients: [
        `${Math.round(p * 0.75 / 0.09)}g red or yellow lentils, dry`,
        `${Math.round(c * 0.4 / 0.28)}g cooked basmati rice`,
        '1 can (400g) diced tomatoes',
        '1/2 onion, 3 cloves garlic, 1 tsp grated ginger',
        `${Math.round(f * 0.2 / 0.81)}g ghee or butter`,
        '1 tsp cumin seeds, 1 tsp turmeric, garam masala, coriander, salt',
        'Fresh cilantro, lemon juice',
      ],
      instructions: [
        'Cook lentils in 2.5 cups water with turmeric until very soft, 20 minutes. Stir until creamy.',
        'Heat ghee. Add cumin seeds and let them sizzle 30 seconds.',
        'Add onion. Cook 5 minutes. Add garlic, ginger, and spices. Cook 1 minute.',
        'Add tomatoes. Cook 8 minutes. Pour into lentils. Simmer 5 more minutes.',
        'Season with salt and lemon juice. Top with cilantro. Serve over basmati rice.',
      ],
    },
    {
      title: 'Spinach & Ricotta Stuffed Portobello',
      ingredients: [
        `${Math.round(p * 0.45 / 0.11)}g part-skim ricotta`,
        `${Math.max(2, Math.round(p * 0.2 / 6))} whole eggs, beaten`,
        `${Math.round(p * 0.1 / 0.07)}g Parmesan, grated`,
        `${Math.round(p * 0.25 / 0.032)}g portobello mushroom caps`,
        '2 cups fresh spinach, wilted and squeezed dry',
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
        '1 tsp Italian seasoning, garlic, salt, pepper',
      ],
      instructions: [
        'Preheat oven to 375°F / 190°C.',
        'Mix ricotta, eggs, Parmesan, spinach, garlic, and Italian seasoning.',
        'Brush mushroom caps with olive oil. Fill with ricotta mixture.',
        'Place on a baking sheet.',
        'Bake 22–25 minutes until filling is set and golden.',
      ],
    },
    {
      title: 'Egg Fried Rice with Vegetables',
      ingredients: [
        `${Math.max(3, Math.round(p * 0.6 / 6))} whole eggs, beaten`,
        `${Math.round(c * 0.5 / 0.28)}g cooked brown rice (day-old is best)`,
        '1 cup frozen peas and carrots',
        '1/2 onion, diced',
        `${Math.round(p * 0.15 / 0.07)}g shredded mozzarella or cheddar`,
        '3 tbsp low-sodium soy sauce or tamari',
        `${Math.round(f * 0.25 / 0.92)} tsp sesame oil`,
        '2 cloves garlic, 2 spring onions, sliced',
      ],
      instructions: [
        'Heat sesame oil in a large wok or skillet over high heat.',
        'Add onion and garlic. Stir-fry 2 minutes.',
        'Add frozen peas and carrots. Cook 2 minutes.',
        'Push to the side. Pour in eggs and scramble until just set. Mix with vegetables.',
        'Add rice and soy sauce. Stir-fry 3 minutes. Top with cheese and spring onions.',
      ],
    },
  ];
}
...
function getVegetarianSnackSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Greek Yogurt Tzatziki & Veggie Sticks',
      ingredients: [
        `${Math.round(p * 0.75 / 0.10)}g full-fat Greek yogurt`,
      ...
      instructions: [
        'Mix Greek yogurt, grated cucumber, garlic, dill, and lemon juice.',
        'Season with salt and pepper.',
        'Cut vegetables into sticks.',
        'Serve tzatziki in a bowl surrounded by veggie sticks.',
        'Chill for 10 minutes for best flavor.',
      ],
    },
    {
      title: 'Mini Veggie Egg Muffins',
      ingredients: [
        `${Math.max(4, Math.round(p * 0.8 / 6))} whole eggs`,
      ...
      instructions: [
        ...
        'Whisk eggs with salt, pepper, and Italian seasoning. Pour over vegetables.',
        'Top each with shredded mozzarella.',
        'Bake 18–20 minutes until set and golden. Cool slightly before removing.',
      ],
    },
    {
      title: 'Sunflower Seed & Date Energy Balls',
      ingredients: [
        `${Math.round(f * 0.45 / 0.49)}g sunflower seeds`,
        `${Math.round(c * 0.45 / 0.65)}g Medjool dates, pitted`,
        `${Math.round(p * 0.3 / 0.31)}g hemp seeds`,
        '1 tbsp shredded coconut',
        '1 tsp vanilla extract',
        'Pinch of sea salt',
      ...
      instructions: [
        'Blend dates until smooth and sticky.',
        'Add sunflower seeds, hemp seeds, coconut, vanilla, and salt. Process until combined.',
        'If too sticky, refrigerate dough 10 minutes.',
        'Roll into 1 tbsp-sized balls.',
        'Refrigerate 20 minutes until firm. Store in fridge up to 1 week.',
      ],
    },
    {
      title: 'Mozzarella & Cherry Tomato Skewers',
      ingredients: [
        `${Math.round(p * 0.7 / 0.18)}g fresh mozzarella balls (ciliegine)`,
        '1 cup cherry tomatoes',
        '1 cup fresh basil leaves',
        `${Math.round(f * 0.45 / 0.92)} tsp extra virgin olive oil`,
        '1 tbsp balsamic glaze',
      ...
      instructions: [
        'Thread a basil leaf, cherry tomato, and mozzarella ball onto each small skewer.',
        'Arrange on a plate.',
    ...
    {
      title: 'Edamame & Avocado Smash on Rice Cakes',
      ingredients: [
        `${Math.round(p * 0.6 / 0.11)}g shelled edamame, steamed`,
        `${Math.round(f * 0.4 / 0.15)}g avocado, mashed`,
        `${Math.max(2, Math.round(c * 0.35 / 8))} plain rice cakes`,
        ...
        'Salt, black sesame seeds',
      ],
      instructions: [
        'Steam edamame until tender, 4–5 minutes.',
        'Mash avocado with lime juice and salt.',
        'Spread avocado mash on each rice cake.',
        'Top with edamame.',
        'Sprinkle chili flakes and sesame seeds.',
      ],
    },
    {
      title: 'Pea Protein & Banana Shake',
      ingredients: [
        '1.5 scoops vanilla pea protein powder (~30g protein)',
        `${Math.round(c * 0.4 / 0.14)}g frozen banana`,
...
function getLowCarbBreakfastSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Smoked Mackerel & Soft Boiled Eggs',
      ingredients: [
        `${Math.round(p * 0.65 / 0.20)}g smoked mackerel fillet, flaked`,
        `${Math.max(2, Math.round(p * 0.35 / 6))} soft boiled eggs, halved`,
        '2 cups mixed greens',
        '1/2 cup cherry tomatoes, halved',
        `${Math.round(f * 0.3 / 0.92)} tsp olive oil`,
      ...
      instructions: [
        'Soft boil eggs: simmer 6 minutes, then cool in ice water. Peel and halve.',
        'Flake mackerel into large pieces over mixed greens.',
        'Add eggs and tomatoes.',
        'Drizzle olive oil and lemon juice.',
        'Top with fresh dill. Season with salt and pepper.',
      ],
    },
    {
      title: 'Beef & Egg Breakfast Skillet',
      ingredients: [
        `${Math.round(p * 0.6 / 0.26)}g lean ground beef (90%)`,
        `${Math.max(2, Math.round(p * 0.4 / 6))} whole eggs`,
        '1/2 red bell pepper, diced',
        '1/4 onion, diced',
        `${Math.round(f * 0.25 / 0.81)}g butter`,
        '1 tsp garlic powder, onion powder, smoked paprika, salt',
      ],
      instructions: [
        'Brown ground beef over medium-high heat, breaking apart, 5 minutes.',
        'Add onion and pepper. Cook 3 minutes.',
        'Season with garlic powder, paprika, and salt.',
        'Make wells in the mixture. Add butter, then crack eggs into wells.',
    ...
    },
    {
      ...
      ingredients: [
        `${Math.round(c * 0.35 / 0.03)}g zucchini, grated and squeezed dry`,
        `${Math.max(2, Math.round(p * 0.5 / 6))} whole eggs`,
        `${Math.round(p * 0.35 / 0.25)}g shredded cheddar cheese`,
        '2 tbsp almond flour',
        '1/4 onion, grated',
        `${Math.round(f * 0.3 / 0.92)} tsp olive oil`,
        'Salt, pepper, garlic powder',
      ...
      instructions: [
        'Grate zucchini. Squeeze very dry in a towel.',
        'Mix with eggs, cheddar, almond flour, grated onion, and seasoning.',
        'Heat olive oil over medium heat.',
        'Drop 1/4 cup portions into pan. Flatten. Cook 3–4 minutes per side until golden.',
        'Serve with sour cream.',
      ],
    },
    {
      title: 'Chicken & Avocado Morning Bowl',
      ingredients: [
        `${Math.round(p * 0.8 / 0.31)}g cooked chicken breast, shredded or diced`,
        `${Math.round(f * 0.5 / 0.15)}g avocado, sliced`,
      ...
      instructions: [
        'Use leftover cooked chicken or quickly pan-sear seasoned chicken breast 5–6 minutes per side.',
    ...
    {
      title: 'Cream Cheese & Chive Stuffed Omelette',
      ingredients: [
        `${Math.max(3, Math.round(p * 0.7 / 6))} whole eggs`,
        `${Math.round(p * 0.25 / 0.08)}g cream cheese, softened`,
      ...
      instructions: [
        ...
        'Pour in eggs. Cook until edges set, then gently lift to let raw egg flow underneath.',
        'Spread cream cheese on one half. Add spinach and chives.',
        'Fold omelette. Cook 1 more minute. Slide onto plate.',
      ],
    },
    {
      title: 'Sardines & Scrambled Eggs',
      ingredients: [
        `${Math.round(p * 0.5 / 0.25)}g canned sardines in olive oil, drained`,
        `${Math.max(3, Math.round(p * 0.5 / 6))} whole eggs`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        '1/2 cup cherry tomatoes, halved',
      ...
      instructions: [
        'Whisk eggs with salt and pepper.',
        'Melt butter in a pan over low heat. Add eggs. Scramble gently until just set.',
        'Arrange sardines alongside scrambled eggs.',
        'Add cherry tomatoes on the side.',
        'Squeeze lemon juice over sardines. Top with fresh dill.',
      ],
    },
  ];
}
...
function getLowCarbLunchSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Zucchini Boats with Ground Beef & Mozzarella',
      ingredients: [
        `${Math.round(p * 0.75 / 0.26)}g lean ground beef (90%)`,
      ...
      instructions: [
        'Preheat oven to 400°F / 200°C. Scoop out zucchini flesh, creating boats.',
        'Brown ground beef with onion in olive oil 5 minutes. Add garlic and Italian seasoning.',
        'Add tomatoes. Cook 3 minutes. Season.',
        'Fill zucchini boats with beef mixture. Top with mozzarella.',
        'Bake 20–22 minutes until zucchini is tender and cheese is golden.',
      ],
    },
    {
      title: 'Smoked Mackerel & Avocado Salad',
      ingredients: [
        `${Math.round(p * 0.75 / 0.20)}g smoked mackerel fillet, flaked`,
        `${Math.round(f * 0.45 / 0.15)}g avocado, diced`,
        '3 cups mixed greens or watercress',
        '1/2 cucumber, diced',
        '1/4 red onion, thinly sliced',
        `${Math.round(f * 0.15 / 0.92)} tsp extra virgin olive oil`,
        '1 tbsp lemon juice, fresh dill, salt, pepper',
      ],
      instructions: [
        'Flake mackerel into large pieces over mixed greens.',
        ...
        'Toss gently — don\'t break up the avocado or mackerel too much.',
      ],
    },
    {
      title: 'Beef Lettuce Burger',
      ingredients: [
        `${Math.round(p * 0.8 / 0.26)}g ground beef (80/20), formed into patty`,
        `${Math.round(f * 0.3 / 0.15)}g avocado, sliced`,
        '4 large butter lettuce leaves (2 for each "bun")',
      ...
      instructions: [
        'Season beef with salt, pepper, and garlic powder. Form a thick patty.',
        'Cook in a skillet over medium-high 4 minutes per side for medium. Rest 3 minutes.',
        'Spread mayo and mustard on the lettuce leaves.',
        'Stack: lettuce, patty, avocado, onion, tomato, lettuce on top.',
        'Eat immediately — hold together with a toothpick if needed.',
      ],
    },
    {
      title: 'Chicken Cobb Salad',
      ingredients: [
        `${Math.round(p * 0.6 / 0.31)}g chicken breast, grilled and sliced`,
        `${Math.max(2, Math.round(p * 0.2 / 6))} hard boiled eggs, halved`,
        `${Math.round(p * 0.1 / 0.35)}g bacon, cooked and crumbled`,
        `${Math.round(f * 0.3 / 0.15)}g avocado, diced`,
        '3 cups romaine lettuce, chopped',
        '1/2 cup cherry tomatoes, halved',
        `${Math.round(f * 0.15 / 0.33)}g blue cheese or cheddar, crumbled`,
        '3 tbsp ranch or blue cheese dressing',
      ],
      instructions: [
        'Arrange romaine on a large plate.',
        'Place rows of chicken, eggs, bacon, avocado, and tomatoes on top.',
    ...
    {
      title: 'Pork Belly & Bok Choy Bowl',
      ingredients: [
        `${Math.round(p * 0.85 / 0.09)}g pork belly, cubed`,
      ...
      instructions: [
        'Roast pork belly at 400°F / 200°C for 30 minutes until crispy.',
        'Melt butter in a pan over medium heat. Add garlic and ginger. Cook 1 minute.',
        'Add bok choy cut-side down. Cook 3 minutes until browned.',
        'Add soy sauce and sesame oil. Toss. Season.',
        'Plate bok choy and top with crispy pork belly.',
      ],
    },
    {
      title: 'Spicy Tuna & Cucumber Boats',
      ingredients: [
        `${Math.round(p * 0.8 / 0.30)}g canned tuna in water, drained`,
        '2 large cucumbers, halved lengthwise',
        '1 tbsp avocado oil mayo',
        '1 tsp sriracha or chili garlic sauce',
        `${Math.round(f * 0.3 / 0.15)}g avocado, mashed`,
        '1 tsp sesame oil, 1 tbsp lime juice',
        `${Math.round(f * 0.1 / 0.49)}g sesame seeds`,
        'Sliced spring onions',
      ],
      instructions: [
        'Scoop seeds from cucumber halves to create boats.',
        'Mix tuna with mayo, sriracha, and sesame oil.',
        'Spread avocado mash in the base of each cucumber boat.',
        'Spoon spicy tuna on top.',
        'Sprinkle sesame seeds and spring onions. Squeeze lime juice over everything.',
      ],
    },
  ];
}
...
function getLowCarbDinnerSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Venison Steak with Roasted Asparagus',
      ingredients: [
        `${Math.round(p * 0.9 / 0.26)}g venison steak`,
        '1 bunch asparagus, trimmed',
        `${Math.round(f * 0.25 / 0.81)}g butter`,
        '2 cloves garlic, minced',
      ...
      instructions: [
        'Toss asparagus in olive oil, salt, and pepper. Roast at 400°F / 200°C for 12 minutes.',
        'Season venison generously with salt and pepper.',
        'Heat a cast iron skillet until very hot. Sear steak 3 minutes per side for medium-rare.',
        'Add butter, garlic, and rosemary. Baste steak for 1 minute.',
        'Rest steak 5 minutes. Slice and plate with asparagus.',
      ],
    },
    {
      title: 'Seared Duck Breast with Wilted Greens',
      ingredients: [
        `${Math.round(p * 0.85 / 0.27)}g duck breast, skin-on`,
        '4 cups spinach or kale, stems removed',
      ...
      instructions: [
        'Score duck skin in a crosshatch pattern. Season with salt, pepper, and thyme.',
        'Place duck skin-side down in a cold skillet. Raise to medium heat. Cook 8 minutes until skin is crispy.',
        'Flip. Cook 4 minutes more. Rest 5 minutes.',
        'In the same skillet with duck fat, sauté garlic 30 seconds. Add greens. Cook until wilted.',
        'Add butter and balsamic if using. Season. Slice duck and serve over greens.',
      ],
    },
    {
      title: 'Lamb Meatballs with Roasted Cauliflower',
      ingredients: [
        `${Math.round(p * 0.8 / 0.25)}g ground lamb`,
      ...
      instructions: [
        'Toss cauliflower in olive oil, salt, and cumin. Roast at 400°F / 200°C for 20 minutes.',
        'Combine lamb, egg, garlic, cinnamon, coriander, salt, and pepper. Form into meatballs.',
        'Pan-fry meatballs over medium-high heat 8–10 minutes, turning, until cooked through.',
        'Plate roasted cauliflower and top with lamb meatballs.',
        'Garnish with fresh mint.',
      ],
    },
    {
      title: 'Baked Cod with Lemon Butter & Broccoli',
      ingredients: [
        `${Math.round(p * 0.9 / 0.18)}g cod fillets`,
        '2 cups broccoli florets',
        `${Math.round(f * 0.3 / 0.81)}g butter, melted`,
        '2 cloves garlic, minced',
        '1 lemon, juice and zest',
        'Fresh parsley, salt, pepper, paprika',
      ],
      instructions: [
        'Preheat oven to 400°F / 200°C.',
        'Toss broccoli in a little of the melted butter, salt, and pepper. Place on one side of a baking tray.',
        'Place cod on the other side. Mix remaining butter with garlic, lemon juice, zest, and parsley. Spoon over cod.',
        'Season cod with paprika, salt, and pepper.',
        'Bake 15–18 minutes until cod flakes easily. Serve together.',
      ],
    },
    {
      title: 'Chicken Piccata (No Pasta)',
      ingredients: [
        `${Math.round(p * 0.9 / 0.31)}g chicken breast, pounded thin`,
        '3 cups zucchini, spiralized or sautéed',
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        '3 tbsp capers',
        '3 tbsp lemon juice',
      ...
      instructions: [
        'Season chicken with salt and pepper. Sear in olive oil over high heat 3 minutes per side. Set aside.',
        'In same pan, add broth, lemon juice, and capers. Bring to a simmer.',
        'Whisk in butter until sauce is glossy. Return chicken to pan. Coat in sauce.',
        'In a separate pan, sauté zucchini in a little butter until just tender. Season.',
        'Plate zucchini, top with chicken and piccata sauce. Garnish with parsley.',
      ],
    },
    {
      title: 'Turkey Meatballs with Zucchini Noodles',
      ingredients: [
        `${Math.round(p * 0.8 / 0.29)}g ground turkey`,
        '3 medium zucchini, spiralized',
        '1 egg',
        '2 cloves garlic, minced',
        '1 tsp Italian seasoning, 1/2 tsp fennel seeds',
        `${Math.round(f * 0.2 / 0.92)} tsp olive oil`,
        '1 cup low-carb marinara sauce',
        'Salt, pepper, fresh basil',
      ],
      instructions: [
        'Combine turkey, egg, garlic, Italian seasoning, fennel, salt, and pepper. Form meatballs.',
        'Brown meatballs in olive oil over medium-high heat, all sides, about 6 minutes.',
        'Add marinara. Simmer covered 8 minutes until cooked through.',
        'Sauté zucchini noodles in a little olive oil 2–3 minutes. Season.',
        'Plate zucchini noodles, top with meatballs and sauce. Garnish with fresh basil.',
      ],
    },
  ];
}
...
function getLowCarbSnackSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Beef Jerky & Macadamia Nuts',
      ingredients: [
        `${Math.round(p * 0.8 / 0.33)}g beef jerky (low-sugar)`,
        `${Math.round(f * 0.5 / 0.76)}g macadamia nuts`,
        'Optional: 1 stick string cheese',
      ],
      instructions: [
        'Portion jerky and macadamia nuts.',
        'Pair with string cheese if desired.',
        'No prep needed — portable, zero-carb snack.',
      ],
    },
    {
      title: 'Smoked Salmon & Cream Cheese Cucumber Rounds',
      ingredients: [
        `${Math.round(p * 0.8 / 0.20)}g smoked salmon`,
        `${Math.round(f * 0.35 / 0.34)}g cream cheese`,
      ...
      instructions: [
        ...
        'Lay a piece of smoked salmon on top.',
        'Add a caper and a pinch of dill to each.',
        'Season with black pepper.',
        'Serve immediately.',
      ],
    },
    {
      title: 'Tuna Avocado Boats',
      ingredients: [
        `${Math.round(p * 0.75 / 0.30)}g canned tuna in water, drained`,
        `${Math.round(f * 0.45 / 0.15)}g avocado`,
        '1 tbsp avocado oil mayo',
        '1 tsp Dijon mustard',
      ...
      instructions: [
        'Halve and pit avocado. Use it as the serving bowl.',
        'Mix tuna with mayo, mustard, red onion, salt, and pepper.',
        'Spoon tuna mix into the avocado halves.',
        'Dust with paprika.',
        'Eat with a spoon — no utensils needed.',
      ],
    },
    {
      title: 'Prosciutto-Wrapped Melon Bites (Low Carb Treat)',
      ingredients: [
        `${Math.round(p * 0.75 / 0.25)}g prosciutto, thin slices`,
        '1/4 cantaloupe, cut into small wedges',
        'Fresh basil leaves',
        'Cracked black pepper',
      ],
      instructions: [
        'Wrap each cantaloupe wedge tightly with a slice of prosciutto.',
        'Tuck a basil leaf under the prosciutto.',
        'Season with cracked black pepper.',
        'Arrange on a plate and serve.',
      ],
    },
    {
      title: 'Devilled Eggs with Bacon',
      ingredients: [
        `${Math.max(2, Math.round(p * 0.6 / 6))} eggs, hard-boiled`,
        `${Math.round(p * 0.3 / 0.35)}g bacon, cooked crispy and crumbled`,
        '1 tbsp avocado oil mayo',
        '1 tsp Dijon mustard',
        '1 tsp apple cider vinegar',
        'Salt, pepper, paprika',
      ...
      instructions: [
        'Halve hard-boiled eggs. Remove yolks to a bowl.',
    ...
    },
    {
      ...
      ingredients: [
        `${Math.round(p * 0.85 / 0.11)}g full-fat cottage cheese`,
        `${Math.round(f * 0.55 / 0.65)}g walnuts, roughly chopped`,
        '1/2 tsp cinnamon',
      ...
      instructions: [
        ...
        'Stir gently and eat immediately.',
      ],
    },
  ];
}
...
function getCarnivoreBreakfastSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Duck Egg & Beef Sausage Skillet',
      ingredients: [
        `${Math.round(p * 0.5 / 0.14)}g beef breakfast sausage`,
        `${Math.max(2, Math.round(p * 0.45 / 7))} duck eggs (or large chicken eggs)`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Cook beef sausage in a skillet over medium heat until browned and cooked through, 6–8 minutes.',
        'Set sausage aside. Add butter to the pan.',
        'Crack duck eggs into the pan. Fry over easy or sunny-side up.',
        'Season with salt.',
        'Plate sausage alongside eggs. Spoon butter over top.',
      ],
    },
    {
      title: 'Liver & Bacon',
      ingredients: [
        `${Math.round(p * 0.65 / 0.26)}g beef liver, sliced`,
        `${Math.round(p * 0.3 / 0.35)}g thick-cut bacon`,
        `${Math.round(f * 0.25 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Cook bacon in a skillet until crispy. Set aside, keep fat in pan.',
        'Pat liver dry and season with salt.',
        'Add butter to bacon fat. Cook liver over medium-high heat, 2 minutes per side — do not overcook.',
        'Plate liver immediately with crispy bacon on the side.',
        'Serve hot — liver continues cooking off heat.',
      ],
    },
    {
      title: 'Bone Marrow & Eggs',
      ingredients: [
        `${Math.round(p * 0.3 / 0.07)}g bone marrow bones (split lengthwise)`,
        `${Math.max(3, Math.round(p * 0.65 / 6))} whole eggs`,
        `${Math.round(f * 0.2 / 0.81)}g butter`,
        'Flaky sea salt',
      ],
      instructions: [
        'Roast marrow bones at 450°F / 230°C for 15 minutes until marrow is soft and bubbling.',
        'Melt butter in a pan and fry or scramble eggs.',
        'Scoop bone marrow from the bone and mix into eggs or eat alongside.',
        'Season everything with flaky sea salt.',
        'Serve immediately.',
      ],
    },
    {
      title: 'Venison Sausage Patties & Soft Boiled Eggs',
      ingredients: [
        `${Math.round(p * 0.6 / 0.26)}g ground venison, seasoned and shaped into patties`,
        `${Math.max(2, Math.round(p * 0.4 / 6))} soft boiled eggs`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        'Salt, black pepper',
      ],
      instructions: [
        'Bring a pot of water to a boil. Add eggs and cook exactly 7 minutes. Transfer to ice water.',
        'Season venison patties with salt and pepper.',
        'Cook patties in butter over medium-high heat, 3–4 minutes per side.',
        'Peel and halve the soft boiled eggs.',
        'Plate venison patties with halved eggs. Drizzle melted butter over eggs.',
      ],
    },
    {
      title: 'Beef Heart & Scrambled Eggs',
      ingredients: [
        `${Math.round(p * 0.6 / 0.17)}g beef heart, thinly sliced`,
        `${Math.max(2, Math.round(p * 0.4 / 6))} whole eggs`,
        `${Math.round(f * 0.35 / 0.81)}g butter`,
        'Salt, garlic powder',
      ],
      instructions: [
        'Season beef heart slices with salt and garlic powder.',
        'Sear in half the butter over very high heat, 1–2 minutes per side. Set aside.',
        'Reduce heat to low. Add remaining butter. Scramble eggs gently until just set.',
        'Plate eggs alongside beef heart slices.',
        'Season with extra salt if needed.',
      ],
    },
    {
      title: 'Crispy Pork Belly & Eggs',
      ingredients: [
        `${Math.round(p * 0.55 / 0.09)}g pork belly, pre-scored`,
        `${Math.max(2, Math.round(p * 0.4 / 6))} whole eggs`,
        `${Math.round(f * 0.2 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Rub pork belly skin with salt. Roast at 425°F / 220°C for 25 minutes until crackling is crispy.',
        'Rest pork belly 5 minutes. Slice.',
        'Fry eggs in butter in a skillet.',
        'Plate crispy pork belly alongside fried eggs.',
...
function getCarnivoreLunchSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Lamb Shoulder Chops',
      ingredients: [
        `${Math.round(p * 0.9 / 0.25)}g lamb shoulder chops`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
      ...
      instructions: [
        'Season lamb chops generously with salt and pepper on both sides.',
        'Heat a heavy skillet until very hot. Sear chops 4 minutes per side.',
        'Add butter, garlic, and rosemary. Baste chops with the foamy butter for 1 minute.',
        'Rest 4 minutes.',
        'Serve with the pan butter drizzled over top.',
      ],
    },
    {
      title: 'Beef Liver Patties',
      ingredients: [
        `${Math.round(p * 0.75 / 0.26)}g ground beef (80/20)`,
        `${Math.round(p * 0.2 / 0.26)}g beef liver, finely minced`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Combine ground beef and minced liver. Season with salt.',
        'Form into thick patties.',
        'Cook in butter over medium-high heat 4 minutes per side until cooked through.',
        'Rest 2 minutes.',
        'Eat with a fork.',
      ],
    },
    {
      title: 'Pork Ribs (No Sauce)',
      ingredients: [
        `${Math.round(p * 0.85 / 0.25)}g pork back ribs or spare ribs`,
        'Salt only',
        `${Math.round(f * 0.2 / 0.81)}g lard or butter (for basting)`,
      ],
      instructions: [
        'Salt ribs generously on all sides.',
        'Roast at 300°F / 150°C uncovered for 2.5 hours until very tender.',
        'Increase heat to 400°F / 200°C. Brush with melted lard. Roast 15 minutes more for caramelization.',
        'Rest 5 minutes.',
        'Eat with hands.',
      ],
    },
    {
      title: 'Chicken Drumsticks Roasted in Butter',
      ingredients: [
        `${Math.round(p * 0.9 / 0.18)}g chicken drumsticks`,
        `${Math.round(f * 0.4 / 0.81)}g butter, melted`,
        'Salt',
      ],
      instructions: [
        'Coat drumsticks in melted butter. Season heavily with salt.',
        'Roast at 425°F / 220°C for 35–40 minutes, turning halfway, until skin is golden and crackling.',
        'Rest 5 minutes.',
        'Serve immediately.',
      ],
    },
    {
      title: 'Seared Calf\'s Liver with Butter',
      ingredients: [
        `${Math.round(p * 0.9 / 0.26)}g calf\'s liver, sliced 1cm thick`,
        `${Math.round(f * 0.4 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Pat liver very dry. Season with salt on both sides.',
        'Melt half the butter in a skillet over very high heat until foaming.',
        'Add liver slices — cook 90 seconds per side. Liver should be pink inside.',
        'Remove and rest 2 minutes.',
        'Add remaining butter to pan, let it brown slightly. Pour over liver. Serve immediately.',
      ],
    },
    {
      title: 'Venison Burger Patty',
      ingredients: [
        `${Math.round(p * 0.85 / 0.26)}g ground venison`,
        `${Math.round(f * 0.3 / 0.35)}g tallow or suet (mixed in for fat)`,
        `${Math.round(f * 0.2 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Mix venison with tallow. Season with salt. Form into a thick patty.',
        'Heat cast iron skillet until very hot.',
        'Cook patty 4 minutes per side for medium. Baste with butter in the last minute.',
        'Rest 4 minutes.',
        'Eat with a knife and fork — no bun needed.',
      ],
    },
  ];
}
...
function getCarnivoreDinnerSwapOptions(p, c, f) {
  return [
    ...
    },
    {
      title: 'Duck Confit',
      ingredients: [
        `${Math.round(p * 0.9 / 0.19)}g duck legs (confit or fresh)`,
        `${Math.round(f * 0.35 / 0.81)}g duck fat or butter`,
        'Salt, fresh thyme',
      ],
      instructions: [
        'If using fresh duck legs: season heavily with salt. Refrigerate uncovered 4+ hours.',
        'Submerge in duck fat. Cook at 275°F / 135°C for 2.5 hours until meat pulls from the bone.',
        'Remove duck. Sear skin-side down in a hot dry pan 3–4 minutes until crackling.',
        'Rest 5 minutes.',
        'Serve immediately.',
      ],
    },
    {
      title: 'Seared Tuna Steak',
      ingredients: [
        `${Math.round(p * 0.9 / 0.30)}g tuna steak (ahi or yellowfin)`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        'Salt, cracked black pepper',
      ],
      instructions: [
        'Pat tuna completely dry. Season all sides with salt and pepper.',
        'Heat a skillet until smoking hot.',
        'Sear tuna 60–90 seconds per side — it should be rare in the center.',
        'Add butter in the last 30 seconds and baste.',
        'Rest 2 minutes. Slice against the grain and serve.',
      ],
    },
    {
      title: 'Slow-Cooked Beef Brisket',
      ingredients: [
        `${Math.round(p * 0.9 / 0.26)}g beef brisket flat`,
        `${Math.round(f * 0.3 / 0.81)}g beef tallow`,
        '1 cup beef bone broth',
        'Salt, black pepper, garlic powder',
      ],
      instructions: [
        'Season brisket generously on all sides. Rub with tallow.',
        'Sear in a heavy pot over high heat, 4 minutes per side.',
        'Add bone broth. Cover and braise at 300°F / 150°C for 3–4 hours until fork-tender.',
        'Rest 10 minutes. Slice against the grain.',
        'Drizzle braising juices over the top.',
      ],
    },
    {
      title: 'Pork Shoulder Steaks',
      ingredients: [
        `${Math.round(p * 0.9 / 0.21)}g pork shoulder steaks, 2cm thick`,
        `${Math.round(f * 0.35 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Season pork steaks generously with salt on both sides.',
        'Heat a skillet over medium-high heat. Add butter.',
        'Cook pork steaks 5 minutes per side until caramelized and cooked through.',
        'Baste with the pan butter in the last minute.',
        'Rest 4 minutes. Serve with pan drippings.',
      ],
    },
    {
      title: 'Whole Roasted Chicken (Drumstick & Thigh Serving)',
      ingredients: [
        `${Math.round(p * 0.9 / 0.18)}g chicken thigh and drumstick, bone-in skin-on`,
        `${Math.round(f * 0.4 / 0.81)}g butter, softened`,
        'Salt',
      ],
      instructions: [
        'Rub butter under and over the skin. Season with salt.',
        'Roast at 425°F / 220°C for 35–40 minutes until skin is deep golden and juices run clear.',
        'Rest 5 minutes.',
        'Eat with hands for maximum enjoyment.',
      ],
    },
    {
      title: 'Lamb Leg Steaks',
      ingredients: [
        `${Math.round(p * 0.9 / 0.25)}g lamb leg steaks, 2cm thick`,
        `${Math.round(f * 0.35 / 0.81)}g butter`,
        '2 cloves garlic, halved (to rub)',
        'Salt, cracked black pepper',
      ],
      instructions: [
        'Rub lamb steaks with cut garlic. Season with salt and pepper.',
        'Heat a heavy skillet to very high heat.',
        'Sear lamb 3–4 minutes per side for medium-rare.',
        'Add butter and baste for 1 minute.',
        'Rest 4 minutes. Serve with pan butter poured over top.',
      ],
    },
  ];
}
...
function getCarnivoreSnackSwapOptions(p, c, f) {
  return [
    ...
    {
      title: 'Pork Rinds (Store-Bought or Homemade)',
      ingredients: [
        `${Math.round(p * 0.8 / 0.67)}g pork rinds (chicharrones)`,
        `${Math.round(f * 0.5 / 0.81)}g lard or duck fat (if making homemade)`,
        'Salt, optional: smoked paprika',
      ],
      instructions: [
        'Store-bought: portion and eat as-is — highest protein-to-carb snack possible.',
        'Homemade: score pork skin, dry overnight in the fridge, then fry in lard at 375°F / 190°C 3 minutes.',
        'Season with extra salt or smoked paprika.',
        'Let cool 1 minute before eating.',
      ],
    },
    {
      title: 'Chicken Wings (Salt Only)',
      ingredients: [
        `${Math.round(p * 0.9 / 0.18)}g chicken wings`,
        `${Math.round(f * 0.3 / 0.81)}g butter`,
        'Flaky sea salt',
      ],
      instructions: [
        'Pat wings completely dry. Season heavily with salt.',
        'Bake at 425°F / 220°C for 40 minutes, flipping halfway.',
        'Toss in melted butter while hot.',
        'Season with flaky sea salt.',
        'Eat with hands.',
      ],
    },
    {
      title: 'Tallow Fried Beef Strips',
      ingredients: [
        `${Math.round(p * 0.9 / 0.26)}g beef sirloin or flank, cut into strips`,
        `${Math.round(f * 0.5 / 0.81)}g beef tallow`,
        'Salt',
      ],
      instructions: [
        'Season beef strips with salt.',
        'Heat tallow in a pan over very high heat until shimmering.',
        'Fry beef strips in batches, 60–90 seconds per side until browned.',
        'Rest 2 minutes.',
        'Season with extra salt and eat hot.',
      ],
    },
    {
      title: 'Carnivore "Cheese Chips" with Ground Beef',
      ingredients: [
        `${Math.round(p * 0.5 / 0.25)}g aged parmesan or cheddar, grated`,
        `${Math.round(p * 0.45 / 0.26)}g ground beef (80/20)`,
        `${Math.round(f * 0.2 / 0.81)}g butter`,
        'Salt',
      ],
      instructions: [
        'Spoon mounds of grated cheese onto a parchment-lined baking tray.',
        'Bake at 375°F / 190°C for 6–8 minutes until bubbly and golden. Cool to crisp.',
        'Brown ground beef in butter. Season with salt.',
        'Eat cheese crisps alongside ground beef.',
      ],
    },
    {
      title: 'Salami & Cheese Roll-Ups',
      ingredients: [
        `${Math.round(p * 0.6 / 0.22)}g salami slices`,
        `${Math.round(p * 0.3 / 0.25)}g cheddar or provolone, sliced`,
        `${Math.round(f * 0.2 / 0.81)}g cream cheese (optional spread)`,
      ],
      instructions: [
        'Lay salami slices flat.',
        'Place a strip of cheese on each slice.',
        'Optionally spread a thin layer of cream cheese.',
        'Roll tightly and secure with a toothpick.',
        'Eat cold — no prep needed.',
      ],
    },
    {
      title: 'Smoked Oysters & Butter',
      ingredients: [
        `${Math.round(p * 0.8 / 0.09)}g canned smoked oysters in olive oil`,
        `${Math.round(f * 0.4 / 0.81)}g butter`,
        'Salt, cracked black pepper',
      ],
      instructions: [
        'Drain smoked oysters. Arrange on a small plate.',
        'Top each oyster with a small knob of cold butter.',
        'Season with cracked black pepper.',
        'Eat immediately — the butter melts over the warm oysters.',
      ],
    },
  ];
}
